...
```
    ...
    <ipython-input-35-015fa4ff08fa> in <module>
          1 for index, value in enumerate(seq):
    ----> 2     print(value)
          3 #     if index > 10:
          4 #         break


    ~/anaconda/envs/cmu3/lib/python3.6/site-packages/ipykernel/iostream.py in write(self, string)
        406                     self.flush()
        407             else:
    --> 408                 self._schedule_flush()
        409 
        410     def writelines(self, sequence):
