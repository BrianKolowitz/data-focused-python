               ...
               {'fullUrl': 'http://hapi.fhir.org/baseR4/Observation/51279',
                'resource': {'code': {'coding': [{'code': 'CRE(1)',
                             ...
                             'valueQuantity': {'code': 'mg/l',
                                               ...
                                               'value': 6}},
                'search': {'mode': 'match'}}],
     'id': '2505125f-f9b1-45f1-8cb3-7f487e9c31bf',
     'link': [{'relation': 'self',
               'url': 'http://hapi.fhir.org/baseR4/Observation?subject=Patient%2F38'},
              {'relation': 'next',
               'url': 'http://hapi.fhir.org/baseR4?_getpages=2505125f-f9b1-45f1-8cb3-7f487e9c31bf&_getpagesoffset=20&_count=20&_pretty=true&_bundletype=searchset'}],
     'meta': {'lastUpdated': '2019-10-31T12:02:31.234+00:00'},
     'resourceType': 'Bundle',
     'total': 204,
     'type': 'searchset'}
...
```
    ...
    <ipython-input-10-814c163e63cc> in <module>
          1 name.given = 'Peter'
